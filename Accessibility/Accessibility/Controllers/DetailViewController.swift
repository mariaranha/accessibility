...
//        self.card.log("DetailVC>> Will layout to: ---> \(rect)")
        ...
        guard isPresenting else {
            ...
            scrollView.layer.cornerRadius = CGFloat(card.cardRadius)
            card.frame = scrollView.bounds
...
//            scrollView.frame.size = CGSize(width: LayoutHelper.XScreen(90), height: LayoutHelper.YScreen(100) - 20)
        ...
        card.frame.origin = scrollView.bounds.origin
        card.frame.size = CGSize( width: scrollView.bounds.width,
